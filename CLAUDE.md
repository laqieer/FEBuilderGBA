...
- `AoeRangeCore.cs` (Core, #1431; WF `AOERANGEForm`) — `ReadAoeRange`/`WriteAoeRange` (4+w*h; in-place else append+`RepointAllReferences`+ZERO old; orphan-refuse; ambient undo); Avalonia `AOERANGEView` manual-addr + dynamic hex grid; NoList.
