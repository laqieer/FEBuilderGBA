...
namespace FEBuilderGBA.Avalonia.ViewModels
{
    ...
    ///   <see cref="RebuildProducerCore.MakeWithProducer(ROM,ROM,uint,string,bool,bool,IProgress{string},CancellationToken)"/> writes a faithful <c>.rebuild</c>
    ...
    public class ToolROMRebuildViewModel : ViewModelBase
    {
        ...
        /// <list type="number">
        ///   <item><see cref="RebuildProducerCore.MakeWithProducer(ROM,ROM,uint,string,bool,bool,IProgress{string},CancellationToken)"/>(rom, vanilla, rebuildAddress,
