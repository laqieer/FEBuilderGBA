...
namespace FEBuilderGBA.Avalonia.ViewModels
{
    public class EventBattleTalkViewModel : ViewModelBase, IDataVerifiable
    {
        static readonly List<EditorFormRef.FieldDef> _fields =
            EditorFormRef.DetectFields(new[] { "W0", "W2", "B4", "B5", "W6", "W8", "B10", "B11", "D12" });
        ...
        public void Write()
        {
            ...
            {
                ["W0"] = AttackerUnit, ["W2"] = DefenderUnit,
                ["B4"] = Map, ["B5"] = Unknown05,
                ["W6"] = AchievementFlag, ["W8"] = Text,
                ["B10"] = Unknown0A, ["B11"] = Unknown0B,
                ["D12"] = EventPointer,
            };
        ...
        public Dictionary<string, string> GetFieldOffsetMap()
        {
            return new Dictionary<string, string>
            {
                ["AttackerUnit"] = "u16@0x00_AttackerUnit",
                ["DefenderUnit"] = "u16@0x02_DefenderUnit",
                ["Map"] = "u8@0x04_Map",
                ["Unknown05"] = "u8@0x05_Unknown05",
                ["AchievementFlag"] = "u16@0x06_AchievementFlag",
                ["Text"] = "u16@0x08_Text",
                ["Unknown0A"] = "u8@0x0A_Unknown0A",
                ["Unknown0B"] = "u8@0x0B_Unknown0B",
                ["EventPointer"] = "u32@0x0C_EventPointer",
            };
        }
    }
}
