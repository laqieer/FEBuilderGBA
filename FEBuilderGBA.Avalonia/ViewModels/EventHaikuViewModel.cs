    ...
    public class EventHaikuViewModel : ViewModelBase, IDataVerifiable
    {
        ...
        public List<AddrResult> LoadList()
        {
            ...
            for (int i = 0; i < 256; i++)
            {
                ...
                // semantics: 0 renders as "ANY" (entry applies to any unit),
                // matching WinForms EventHaikuForm.
        ...
        public Dictionary<string, string> GetFieldOffsetMap()
        {
            ...
            {
                ["Unit"] = "u8@0x00_Unit",
                ["KillerUnit"] = "u8@0x01_KillerUnit",
                ["Route"] = "u8@0x02_Route",
                ["ChapterID"] = "u8@0x03_ChapterID",
                ["AchievementFlag"] = "u16@0x04_AchievementFlag",
                ["Text"] = "u16@0x06_Text",
