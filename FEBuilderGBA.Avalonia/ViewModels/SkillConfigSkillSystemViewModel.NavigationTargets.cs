...
// Phase 4 navigation manifest for SkillConfigSkillSystemViewModel (#427).
//
// The WF `SkillConfigSkillSystemForm.X_N_JumpEditor_Click` opens a
...
{
    public partial class SkillConfigSkillSystemViewModel : INavigationTargetSource
    {
