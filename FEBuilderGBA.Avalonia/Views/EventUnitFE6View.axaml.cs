...
{
    public partial class EventUnitFE6View : Window, IEditorView
    {
        ...
        void LoadList()
        {
            ...
            {
                Log.Error("EventUnitFE6View.LoadList failed: {0}", ex.Message);
            }
        }
        ...
        void OnSelected(uint addr)
        {
            ...
            {
                Log.Error("EventUnitFE6View.OnSelected failed: {0}", ex.Message);
            }
        }
