...
namespace FEBuilderGBA.Avalonia.Views
{
    public partial class EventMoveDataFE7View : Window, IEditorView
    {
        ...
        void LoadList()
        {
            ...
            {
                Log.Error("EventMoveDataFE7View.LoadList failed: {0}", ex.Message);
            }
        }
        ...
        void OnSelected(uint addr)
        {
            ...
            {
                Log.Error("EventMoveDataFE7View.OnSelected failed: {0}", ex.Message);
            }
        }
        ...
        void OnWrite(object? sender, RoutedEventArgs e)
        {
            ...
            {
                Log.Error("EventMoveDataFE7View.OnWrite failed: {0}", ex.Message);
            }
        }
