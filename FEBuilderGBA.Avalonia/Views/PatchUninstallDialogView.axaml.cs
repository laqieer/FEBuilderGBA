...
{
    public partial class PatchUninstallDialogView : TranslatedUserControl, IEmbeddableEditor
    {
        ...
        public EditorDescriptor Descriptor => new("Patch Uninstall", 800, 500, SizeToContent: true);
        public event EventHandler? CloseRequested;
        public void RequestClose() => CloseRequested?.Invoke(this, EventArgs.Empty);

        public PatchUninstallDialogView()
        {
            InitializeComponent();
