...
{
    public partial class OPPrologueViewerView : TranslatedUserControl, IEmbeddableEditor, IDataVerifiableView
    {
        ...
        {
            await ImageDisplay.ExportPng(TopLevel.GetTopLevel(this) as Window, "op_prologue.png");
        }
