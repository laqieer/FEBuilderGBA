...
{
    public partial class SupportTalkFE6View : TranslatedUserControl, IEmbeddableEditor, IDataVerifiableView
    {
        ...
        /// <summary>
        /// #1149: attempt a source-backed write for the support_talks table (FE6).
        ...
        /// <summary>
        /// #358 — select the FE6 support-talk row that pairs the two units
        /// in either order.  Mirrors WinForms <c>SupportTalkFE6Form.JumpTo</c>.
        /// </summary>
        ...
        static uint TextAddrFor(uint textId)
        {
            ...
            // Compute in ulong to detect wrap-around (Copilot review #638).
