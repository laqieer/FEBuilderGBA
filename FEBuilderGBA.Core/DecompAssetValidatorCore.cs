...
namespace FEBuilderGBA
{
    ...
    public enum AssetKind
    {
        ...
        PortraitPackage,
        /// <summary>
        /// LZ77-decompressed 4bpp OBJ tile payload (#1360). The source body is the
    ...
    public static class DecompAssetValidatorCore
    {
        ...
        /// <summary>
        /// Validate a LZ77-decompressed 4bpp OBJ tile payload (#1360). The body is the DECOMPRESSED
