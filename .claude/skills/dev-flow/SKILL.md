...
12. **Check for ALL comments** — both inline threads AND issue-level conversation comments:
    ...
    ```
    **CRITICAL: Always check BOTH.** Human reviewers, Copilot bot, and Copilot CLI may all post comments in either place. Ignoring issue-level comments is a recurring failure mode.
