...
namespace FEBuilderGBA.Tests.Unit
{
    ...
    public class AvaloniaDialogViewTests
    {
        ...
        [InlineData("SupportUnitFE6View.axaml", 1234, 750)]
        [InlineData("SupportTalkFE6View.axaml", 1279, 600)]
        [InlineData("SupportTalkFE7View.axaml", 1279, 720)]
        ...
        [InlineData("UnitActionPointerView.axaml", 1293, 863)]
        ...
        [InlineData("OPClassAlphaNameFE6View.axaml", 1253, 662)]
        [InlineData("StatusParamView.axaml", 1238, 604)]
        [InlineData("StatusRMenuView.axaml", 1238, 604)]
        [InlineData("StatusUnitsMenuView.axaml", 1238, 806)]
