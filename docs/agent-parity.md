...
surface; [`FEBuilderGBA.CLI`](cli-reference.md) (72 commands) is the **agent** surface. For the
...
Counts cited: **72** user-facing CLI commands (`cli-args.md` — "the `Main` dispatcher … routes 72
