...
surface; [`FEBuilderGBA.CLI`](cli-reference.md) (~68 commands) is the **agent** surface. For the
...
Counts cited: **68** user-facing CLI commands (`cli-args.md` — "the `Main` dispatcher … routes 68
