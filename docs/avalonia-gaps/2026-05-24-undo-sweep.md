---
generated: "2026-05-24T17:18:00Z"
git-sha: 584d94d02
sweep-type: undo
---
...
| Tier | Count | % of total |
|---|---:|---:|
| Total write callsites | 1155 | 100% |
| NoUndoServiceField (no plumbing) | 104 | 9.0% |
| MissingScope (unwrapped) | 4 | 0.3% |
| AmbiguousScope (verify) | 0 | 0.0% |
| Covered (healthy) | 1047 | 90.6% |
...
| File | Line | Method | Write | Note |
|---|---:|---|---|---|
| `FEBuilderGBA.Avalonia/Services/ClassFE6CsvManager.cs` | 222 | `ApplyImportCsv` | `rom.write_u8(addr + o, (uint)(byte)ParseStrictSbyte(cols[colIdx].Trim(), csvLine, "base stat"))` | class 'ClassFE6CsvManager' has no UndoService field/property/local |
| `FEBuilderGBA.Avalonia/Services/ClassFE6CsvManager.cs` | 236 | `ApplyImportCsv` | `rom.write_u8(addr + o, (uint)(byte)sv)` | class 'ClassFE6CsvManager' has no UndoService field/property/local |
| `FEBuilderGBA.Avalonia/Services/ClassFE6CsvManager.cs` | 248 | `ApplyImportCsv` | `rom.write_u8(addr + o, (uint)(byte)ParseStrictSbyte(cols[colIdx].Trim(), csvLine, "weapon level"))` | class 'ClassFE6CsvManager' has no UndoService field/property/local |
