...
| NoUndoServiceField (no plumbing) | 188 | 17.3% |
| MissingScope (unwrapped) | 4 | 0.4% |
| AmbiguousScope (verify) | 0 | 0.0% |
| Covered (healthy) | 892 | 82.3% |
