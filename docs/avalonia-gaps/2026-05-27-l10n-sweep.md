...
| 99 | `Start` | ✓ | ✓ | ✗ |
| 110 | `Step1Page` | ✓ | ✓ | ✗ |
| 114 | `Specify an emulator to use for testing.\nPress F5 in FEBuilderGBA to launch the emulator and test the ROM.` | ✓ | ✓ | ✗ |
| 117 | `Step 1/6` | ✓ | ✓ | ✗ |
| 122 | `Emulator:` | ✓ | ✓ | ✗ |
| 127 | `Browse` | ✓ | ✓ | ✗ |
| 133 | `Next` | ✓ | ✓ | ✗ |
| 140 | `Download a stable version of VBA-M` | ✓ | ✓ | ✗ |
| 149 | `Download mGBA` | ✓ | ✓ | ✗ |
| 156 | `Previous` | ✓ | ✓ | ✗ |
| 167 | `Step2Page` | ✓ | ✓ | ✗ |
| 171 | `Configure Event Assembler (EA).\nSome patches are written in EA and require it to install.` | ✓ | ✓ | ✗ |
| 174 | `Step 2/6` | ✓ | ✓ | ✗ |
| 184 | `Browse` | ✓ | ✓ | ✗ |
| 190 | `Next` | ✓ | ✓ | ✗ |
| 197 | `Download the latest EA` | ✓ | ✓ | ✗ |
| 206 | `Skip` | ✓ | ✓ | ✗ |
| 211 | `Previous` | ✓ | ✓ | ✗ |
| 222 | `Step3Page` | ✓ | ✓ | ✗ |
| 226 | `Configure Sappy (or VG Music Studio).\nWhen Sappy is configured, the song-preview button can play music.` | ✓ | ✓ | ✗ |
| 229 | `Step 3/6` | ✓ | ✓ | ✗ |
| 234 | `Sappy:` | ✓ | ✓ | ✗ |
| 239 | `Browse` | ✓ | ✓ | ✗ |
| 245 | `Next` | ✓ | ✓ | ✗ |
| 252 | `Download Sappy` | ✓ | ✓ | ✗ |
| 261 | `Download VG Music Studio` | ✓ | ✓ | ✗ |
| 270 | `Skip Sappy` | ✓ | ✓ | ✗ |
| 275 | `Previous` | ✓ | ✓ | ✗ |
| 286 | `Step4Page` | ✓ | ✓ | ✗ |
| 290 | `Configure the development environment.\nInstalling the toolchain enables ASM development and debugging.` | ✓ | ✓ | ✗ |
| 293 | `Step 4/6` | ✓ | ✓ | ✗ |
| 298 | `Debugger:` | ✓ | ✓ | ✗ |
| 303 | `Browse` | ✓ | ✓ | ✗ |
| 309 | `Assembler:` | ✓ | ✓ | ✗ |
| 314 | `Browse` | ✓ | ✓ | ✗ |
| 320 | `Next` | ✓ | ✓ | ✗ |
| 327 | `Download the latest tools automatically` | ✓ | ✓ | ✗ |
| 336 | `Skip` | ✓ | ✓ | ✗ |
| 341 | `Previous` | ✓ | ✓ | ✗ |
| 352 | `Step5Page` | ✓ | ✓ | ✗ |
| 356 | `Configure utilities used to convert music.` | ✓ | ✓ | ✗ |
| 359 | `Step 5/6` | ✓ | ✓ | ✗ |
| 364 | `gba mus riper` | ✓ | ✓ | ✗ |
| 369 | `Browse` | ✓ | ✓ | ✗ |
| 380 | `Browse` | ✓ | ✓ | ✗ |
...
| 391 | `Browse` | ✓ | ✓ | ✗ |
| 397 | `Next` | ✓ | ✓ | ✗ |
| 404 | `Download the latest tools automatically` | ✓ | ✓ | ✗ |
| 413 | `Skip` | ✓ | ✓ | ✗ |
| 418 | `Previous` | ✓ | ✓ | ✗ |
| 429 | `Step6Page` | ✓ | ✓ | ✗ |
| 433 | `Configure Git (version control).\nGit is used to keep config/patch2 patch data up to date.\nInstalling it makes pulling the latest patches easy.` | ✓ | ✓ | ✗ |
| 436 | `Step 6/6` | ✓ | ✓ | ✗ |
| 446 | `Browse` | ✓ | ✓ | ✗ |
| 452 | `Finish setup` | ✓ | ✓ | ✗ |
| 459 | `Download and install the latest Git automatically` | ✓ | ✓ | ✗ |
| 468 | `Skip` | ✓ | ✓ | ✗ |
| 473 | `Previous` | ✓ | ✓ | ✗ |
| 484 | `SettingNowPage` | ✓ | ✓ | ✗ |
| 486 | `Please wait...` | ✓ | ✓ | ✗ |
| 489 | `Downloading required programs and configuring settings.` | ✓ | ✓ | ✗ |
| 503 | `EndPage` | ✓ | ✓ | ✗ |
| 505 | `All settings complete.` | ✓ | ✓ | ✗ |
| 514 | `Setup is complete. The wizard saved your tool paths and preferences.\n\nYou can change these at any time from Menu -> Options.\n\nPress Finish to close this wizard.` | ✓ | ✓ | ✗ |
| 516 | `Finish` | ✓ | ✓ | ✗ |
...
|---|---:|---|---|---|
| `FEBuilderGBA.Avalonia/Views/ToolInitWizardView.axaml` | 70 | `Button` | `Content` | `日本語` |
| `FEBuilderGBA.Avalonia/Views/ToolInitWizardView.axaml` | 74 | `Button` | `Content` | `中文` |
