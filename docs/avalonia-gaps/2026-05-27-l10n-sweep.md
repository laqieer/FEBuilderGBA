...
| 104 | `Start` | ✓ | ✓ | ✗ |
| 115 | `Step1Page` | ✓ | ✓ | ✗ |
| 119 | `Specify an emulator to use for testing.\nPress F5 in FEBuilderGBA to launch the emulator and test the ROM.` | ✓ | ✓ | ✗ |
| 122 | `Step 1/6` | ✓ | ✓ | ✗ |
| 127 | `Emulator:` | ✓ | ✓ | ✗ |
| 132 | `Browse` | ✓ | ✓ | ✗ |
| 138 | `Next` | ✓ | ✓ | ✗ |
| 145 | `Download a stable version of VBA-M` | ✓ | ✓ | ✗ |
| 154 | `Download mGBA` | ✓ | ✓ | ✗ |
| 161 | `Previous` | ✓ | ✓ | ✗ |
| 172 | `Step2Page` | ✓ | ✓ | ✗ |
| 176 | `Configure Event Assembler (EA).\nSome patches are written in EA and require it to install.` | ✓ | ✓ | ✗ |
| 179 | `Step 2/6` | ✓ | ✓ | ✗ |
| 189 | `Browse` | ✓ | ✓ | ✗ |
| 195 | `Next` | ✓ | ✓ | ✗ |
| 202 | `Download the latest EA` | ✓ | ✓ | ✗ |
| 211 | `Skip` | ✓ | ✓ | ✗ |
| 216 | `Previous` | ✓ | ✓ | ✗ |
| 227 | `Step3Page` | ✓ | ✓ | ✗ |
| 231 | `Configure Sappy (or VG Music Studio).\nWhen Sappy is configured, the song-preview button can play music.` | ✓ | ✓ | ✗ |
| 234 | `Step 3/6` | ✓ | ✓ | ✗ |
| 239 | `Sappy:` | ✓ | ✓ | ✗ |
| 244 | `Browse` | ✓ | ✓ | ✗ |
| 250 | `Next` | ✓ | ✓ | ✗ |
| 257 | `Download Sappy` | ✓ | ✓ | ✗ |
| 266 | `Download VG Music Studio` | ✓ | ✓ | ✗ |
| 275 | `Skip Sappy` | ✓ | ✓ | ✗ |
| 280 | `Previous` | ✓ | ✓ | ✗ |
| 291 | `Step4Page` | ✓ | ✓ | ✗ |
| 295 | `Configure the development environment.\nInstalling the toolchain enables ASM development and debugging.` | ✓ | ✓ | ✗ |
| 298 | `Step 4/6` | ✓ | ✓ | ✗ |
| 303 | `Debugger:` | ✓ | ✓ | ✗ |
| 308 | `Browse` | ✓ | ✓ | ✗ |
| 314 | `Assembler:` | ✓ | ✓ | ✗ |
| 319 | `Browse` | ✓ | ✓ | ✗ |
| 325 | `Next` | ✓ | ✓ | ✗ |
| 332 | `Download the latest tools automatically` | ✓ | ✓ | ✗ |
| 341 | `Skip` | ✓ | ✓ | ✗ |
| 346 | `Previous` | ✓ | ✓ | ✗ |
| 357 | `Step5Page` | ✓ | ✓ | ✗ |
| 361 | `Configure utilities used to convert music.` | ✓ | ✓ | ✗ |
| 364 | `Step 5/6` | ✓ | ✓ | ✗ |
| 369 | `gba mus riper` | ✓ | ✓ | ✗ |
| 374 | `Browse` | ✓ | ✓ | ✗ |
| 385 | `Browse` | ✓ | ✓ | ✗ |
...
| 396 | `Browse` | ✓ | ✓ | ✗ |
| 402 | `Next` | ✓ | ✓ | ✗ |
| 409 | `Download the latest tools automatically` | ✓ | ✓ | ✗ |
| 418 | `Skip` | ✓ | ✓ | ✗ |
| 423 | `Previous` | ✓ | ✓ | ✗ |
| 434 | `Step6Page` | ✓ | ✓ | ✗ |
| 438 | `Configure Git (version control).\nGit is used to keep config/patch2 patch data up to date.\nInstalling it makes pulling the latest patches easy.` | ✓ | ✓ | ✗ |
| 441 | `Step 6/6` | ✓ | ✓ | ✗ |
| 451 | `Browse` | ✓ | ✓ | ✗ |
| 457 | `Finish setup` | ✓ | ✓ | ✗ |
| 464 | `Download and install the latest Git automatically` | ✓ | ✓ | ✗ |
| 473 | `Skip` | ✓ | ✓ | ✗ |
| 478 | `Previous` | ✓ | ✓ | ✗ |
| 489 | `SettingNowPage` | ✓ | ✓ | ✗ |
| 491 | `Please wait...` | ✓ | ✓ | ✗ |
| 494 | `Downloading required programs and configuring settings.` | ✓ | ✓ | ✗ |
| 508 | `EndPage` | ✓ | ✓ | ✗ |
| 510 | `All settings complete.` | ✓ | ✓ | ✗ |
| 519 | `Setup is complete. The wizard saved your tool paths and preferences.\n\nYou can change these at any time from Menu -> Options.\n\nPress Finish to close this wizard.` | ✓ | ✓ | ✗ |
| 522 | `Finish` | ✓ | ✓ | ✗ |
...
|---|---:|---|---|---|
| `FEBuilderGBA.Avalonia/Views/ToolInitWizardView.axaml` | 75 | `Button` | `Content` | `日本語` |
| `FEBuilderGBA.Avalonia/Views/ToolInitWizardView.axaml` | 79 | `Button` | `Content` | `中文` |
