...
| 295 | `Browse` | ✓ | ✓ | ✗ |
| 301 | `Next` | ✓ | ✓ | ✗ |
| 308 | `Download the latest tools automatically` | ✓ | ✓ | ✗ |
| 317 | `Skip` | ✓ | ✓ | ✗ |
| 322 | `Previous` | ✓ | ✓ | ✗ |
| 333 | `Step5Page` | ✓ | ✓ | ✗ |
| 337 | `Configure utilities used to convert music.` | ✓ | ✓ | ✗ |
| 340 | `Step 5/6` | ✓ | ✓ | ✗ |
| 345 | `gba mus riper` | ✓ | ✓ | ✗ |
| 350 | `Browse` | ✓ | ✓ | ✗ |
| 361 | `Browse` | ✓ | ✓ | ✗ |
...
| 372 | `Browse` | ✓ | ✓ | ✗ |
| 378 | `Next` | ✓ | ✓ | ✗ |
| 385 | `Download the latest tools automatically` | ✓ | ✓ | ✗ |
| 394 | `Skip` | ✓ | ✓ | ✗ |
| 399 | `Previous` | ✓ | ✓ | ✗ |
| 410 | `Step6Page` | ✓ | ✓ | ✗ |
| 414 | `Configure Git (version control).\nGit is used to keep config/patch2 patch data up to date.\nInstalling it makes pulling the latest patches easy.` | ✓ | ✓ | ✗ |
| 417 | `Step 6/6` | ✓ | ✓ | ✗ |
| 427 | `Browse` | ✓ | ✓ | ✗ |
| 433 | `Finish setup` | ✓ | ✓ | ✗ |
| 440 | `Download and install the latest Git automatically` | ✓ | ✓ | ✗ |
| 449 | `Skip` | ✓ | ✓ | ✗ |
| 454 | `Previous` | ✓ | ✓ | ✗ |
| 465 | `SettingNowPage` | ✓ | ✓ | ✗ |
| 467 | `Please wait...` | ✓ | ✓ | ✗ |
| 470 | `Downloading required programs and configuring settings.` | ✓ | ✓ | ✗ |
| 484 | `EndPage` | ✓ | ✓ | ✗ |
| 486 | `All settings complete.` | ✓ | ✓ | ✗ |
| 495 | `Setup is complete. The wizard saved your tool paths and preferences.\n\nYou can change these at any time from Menu -> Options.\n\nPress Finish to close this wizard.` | ✓ | ✓ | ✗ |
| 497 | `Finish` | ✓ | ✓ | ✗ |
...
|---|---:|---|---|---|
| `FEBuilderGBA.Avalonia/Views/ToolInitWizardView.axaml` | 51 | `Button` | `Content` | `日本語` |
| `FEBuilderGBA.Avalonia/Views/ToolInitWizardView.axaml` | 55 | `Button` | `Content` | `中文` |
