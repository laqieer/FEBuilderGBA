...
| 103 | `Start` | ✓ | ✓ | ✗ |
| 114 | `Step1Page` | ✓ | ✓ | ✗ |
| 118 | `Specify an emulator to use for testing.\nPress F5 in FEBuilderGBA to launch the emulator and test the ROM.` | ✓ | ✓ | ✗ |
| 121 | `Step 1/6` | ✓ | ✓ | ✗ |
| 126 | `Emulator:` | ✓ | ✓ | ✗ |
| 131 | `Browse` | ✓ | ✓ | ✗ |
| 137 | `Next` | ✓ | ✓ | ✗ |
| 144 | `Download a stable version of VBA-M` | ✓ | ✓ | ✗ |
| 153 | `Download mGBA` | ✓ | ✓ | ✗ |
| 160 | `Previous` | ✓ | ✓ | ✗ |
| 171 | `Step2Page` | ✓ | ✓ | ✗ |
| 175 | `Configure Event Assembler (EA).\nSome patches are written in EA and require it to install.` | ✓ | ✓ | ✗ |
| 178 | `Step 2/6` | ✓ | ✓ | ✗ |
| 188 | `Browse` | ✓ | ✓ | ✗ |
| 194 | `Next` | ✓ | ✓ | ✗ |
| 201 | `Download the latest EA` | ✓ | ✓ | ✗ |
| 210 | `Skip` | ✓ | ✓ | ✗ |
| 215 | `Previous` | ✓ | ✓ | ✗ |
| 226 | `Step3Page` | ✓ | ✓ | ✗ |
| 230 | `Configure Sappy (or VG Music Studio).\nWhen Sappy is configured, the song-preview button can play music.` | ✓ | ✓ | ✗ |
| 233 | `Step 3/6` | ✓ | ✓ | ✗ |
| 238 | `Sappy:` | ✓ | ✓ | ✗ |
| 243 | `Browse` | ✓ | ✓ | ✗ |
| 249 | `Next` | ✓ | ✓ | ✗ |
| 256 | `Download Sappy` | ✓ | ✓ | ✗ |
| 265 | `Download VG Music Studio` | ✓ | ✓ | ✗ |
| 274 | `Skip Sappy` | ✓ | ✓ | ✗ |
| 279 | `Previous` | ✓ | ✓ | ✗ |
| 290 | `Step4Page` | ✓ | ✓ | ✗ |
| 294 | `Configure the development environment.\nInstalling the toolchain enables ASM development and debugging.` | ✓ | ✓ | ✗ |
| 297 | `Step 4/6` | ✓ | ✓ | ✗ |
| 302 | `Debugger:` | ✓ | ✓ | ✗ |
| 307 | `Browse` | ✓ | ✓ | ✗ |
| 313 | `Assembler:` | ✓ | ✓ | ✗ |
| 318 | `Browse` | ✓ | ✓ | ✗ |
| 324 | `Next` | ✓ | ✓ | ✗ |
| 331 | `Download the latest tools automatically` | ✓ | ✓ | ✗ |
| 340 | `Skip` | ✓ | ✓ | ✗ |
| 345 | `Previous` | ✓ | ✓ | ✗ |
| 356 | `Step5Page` | ✓ | ✓ | ✗ |
| 360 | `Configure utilities used to convert music.` | ✓ | ✓ | ✗ |
| 363 | `Step 5/6` | ✓ | ✓ | ✗ |
| 368 | `gba mus riper` | ✓ | ✓ | ✗ |
| 373 | `Browse` | ✓ | ✓ | ✗ |
| 384 | `Browse` | ✓ | ✓ | ✗ |
...
| 395 | `Browse` | ✓ | ✓ | ✗ |
| 401 | `Next` | ✓ | ✓ | ✗ |
| 408 | `Download the latest tools automatically` | ✓ | ✓ | ✗ |
| 417 | `Skip` | ✓ | ✓ | ✗ |
| 422 | `Previous` | ✓ | ✓ | ✗ |
| 433 | `Step6Page` | ✓ | ✓ | ✗ |
| 437 | `Configure Git (version control).\nGit is used to keep config/patch2 patch data up to date.\nInstalling it makes pulling the latest patches easy.` | ✓ | ✓ | ✗ |
| 440 | `Step 6/6` | ✓ | ✓ | ✗ |
| 450 | `Browse` | ✓ | ✓ | ✗ |
| 456 | `Finish setup` | ✓ | ✓ | ✗ |
| 463 | `Download and install the latest Git automatically` | ✓ | ✓ | ✗ |
| 472 | `Skip` | ✓ | ✓ | ✗ |
| 477 | `Previous` | ✓ | ✓ | ✗ |
| 488 | `SettingNowPage` | ✓ | ✓ | ✗ |
| 490 | `Please wait...` | ✓ | ✓ | ✗ |
| 493 | `Downloading required programs and configuring settings.` | ✓ | ✓ | ✗ |
| 507 | `EndPage` | ✓ | ✓ | ✗ |
| 509 | `All settings complete.` | ✓ | ✓ | ✗ |
| 518 | `Setup is complete. The wizard saved your tool paths and preferences.\n\nYou can change these at any time from Menu -> Options.\n\nPress Finish to close this wizard.` | ✓ | ✓ | ✗ |
| 521 | `Finish` | ✓ | ✓ | ✗ |
...
|---|---:|---|---|---|
| `FEBuilderGBA.Avalonia/Views/ToolInitWizardView.axaml` | 74 | `Button` | `Content` | `日本語` |
| `FEBuilderGBA.Avalonia/Views/ToolInitWizardView.axaml` | 78 | `Button` | `Content` | `中文` |
