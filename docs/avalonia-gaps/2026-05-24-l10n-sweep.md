---
generated: "2026-05-24T17:18:01Z"
git-sha: 584d94d02
sweep-type: l10n
languages: ja,zh,ko
---
...
| 18 | `Address:` | ✓ | ✓ | ✗ |
| 20 | `Name:` | ✓ | ✓ | ✗ |
| 32 | `This class is referenced by hardcoded ASM. Click to view related patches.` | ✓ | ✓ | ✗ |
| 37 | `Read Start Address:` | ✓ | ✓ | ✗ |
| 39 | `Read Count:` | ✓ | ✓ | ✗ |
| 41 | `Size:` | ✓ | ✓ | ✗ |
| 43 | `Reload` | ✓ | ✓ | ✗ |
| 47 | `Identity / Misc` | ✓ | ✓ | ✗ |
| 50 | `Name ID (W0):` | ✓ | ✓ | ✗ |
| 53 | `Text ID for this class's display name (click to open Text Viewer)` | ✓ | ✓ | ✗ |
| 55 | `Desc ID (W2):` | ✓ | ✓ | ✗ |
| 58 | `Text ID for this class's description (click to open Text Viewer)` | ✓ | ✓ | ✗ |
| 61 | `Class # (B4):` | ✓ | ✓ | ✗ |
| 62 | `Internal class number` | ✓ | ✓ | ✗ |
| 64 | `Promo Lv (B5):` | ✓ | ✓ | ✗ |
| 65 | `Class change class (0 = no promotion)` | ✓ | ✓ | ✗ |
| 68 | `Wait Icon (B6):` | ✓ | ✓ | ✗ |
| 69 | `Map sprite index when idle` | ✓ | ✓ | ✗ |
| 71 | `Walk Spd (B7):` | ✓ | ✓ | ✗ |
| 72 | `Walking speed on the map` | ✓ | ✓ | ✗ |
| 75 | `Portrait (W8):` | ✓ | ✓ | ✗ |
| 78 | `Generic enemy face portrait (click to open Portrait Viewer)` | ✓ | ✓ | ✗ |
| 80 | `Sort Order (B10):` | ✓ | ✓ | ✗ |
| 81 | `Sort order for class list` | ✓ | ✓ | ✗ |
| 88 | `Base Stats` | ✓ | ✓ | ✗ |
| 91 | `HP (B11):` | ✓ | ✓ | ✗ |
| 92 | `Base HP for this class` | ✓ | ✓ | ✗ |
| 94 | `Str (B12):` | ✓ | ✓ | ✗ |
| 97 | `Skl (B13):` | ✓ | ✓ | ✗ |
| 99 | `Spd (B14):` | ✓ | ✓ | ✗ |
| 102 | `Def (B15):` | ✓ | ✓ | ✗ |
| 104 | `Res (B16):` | ✓ | ✓ | ✗ |
| 107 | `Con (B17):` | ✓ | ✓ | ✗ |
| 108 | `Base constitution` | ✓ | ✓ | ✗ |
| 110 | `Mov (B18):` | ✓ | ✓ | ✗ |
| 111 | `Base movement range` | ✓ | ✓ | ✗ |
| 118 | `Stat Caps (Max Values)` | ✓ | ✓ | ✗ |
| 121 | `Max HP (B19):` | ✓ | ✓ | ✗ |
| 122 | `Maximum HP stat cap for this class` | ✓ | ✓ | ✗ |
| 124 | `Max Str (B20):` | ✓ | ✓ | ✗ |
| 127 | `Max Skl (B21):` | ✓ | ✓ | ✗ |
| 129 | `Max Spd (B22):` | ✓ | ✓ | ✗ |
| 132 | `Max Def (B23):` | ✓ | ✓ | ✗ |
...
| 137 | `Max Con (B25):` | ✓ | ✓ | ✗ |
| 139 | `Power (B26):` | ✓ | ✓ | ✗ |
| 140 | `Class power / EXP correction value` | ✓ | ✓ | ✗ |
| 147 | `Growth Rates` | ✓ | ✓ | ✗ |
| 150 | `HP (B27):` | ✓ | ✓ | ✗ |
| 152 | `Str (B28):` | ✓ | ✓ | ✗ |
| 155 | `Skl (B29):` | ✓ | ✓ | ✗ |
...
| 162 | `Res (B32):` | ✓ | ✓ | ✗ |
| 165 | `Lck (B33):` | ✓ | ✓ | ✗ |
| 172 | `Promotion Gains (CC Bonus)` | ✓ | ✓ | ✗ |
| 175 | `HP (b34):` | ✓ | ✓ | ✗ |
| 176 | `HP bonus gained on class change` | ✓ | ✓ | ✗ |
| 178 | `Str (b35):` | ✓ | ✓ | ✗ |
| 185 | `Ability Flags` | ✓ | ✓ | ✗ |
| 188 | `Ability 1 (B36):` | ✓ | ✓ | ✗ |
| 190 | `Ability 2 (B37):` | ✓ | ✓ | ✗ |
| 192 | `Ability 3 (B38):` | ✓ | ✓ | ✗ |
| 194 | `Ability 4 (B39):` | ✓ | ✓ | ✗ |
| 201 | `Weapon Rank Levels (B40-B47)` | ✓ | ✓ | ✗ |
| 204 | `Sword (B40):` | ✓ | ✓ | ✗ |
| 209 | `Lance (B41):` | ✓ | ✓ | ✗ |
| 215 | `Axe (B42):` | ✓ | ✓ | ✗ |
| 220 | `Bow (B43):` | ✓ | ✓ | ✗ |
...
| 237 | `Light (B46):` | ✓ | ✓ | ✗ |
| 242 | `Dark (B47):` | ✓ | ✓ | ✗ |
| 252 | `Pointers / Movement / Terrain` | ✓ | ✓ | ✗ |
| 255 | `Battle Anime (P48):` | ✓ | ✓ | ✗ |
| 256 | `Pointer to battle animation data` | ✓ | ✓ | ✗ |
| 259 | `Jump` | ✓ | ✓ | ✗ |
| 261 | `Move Cost (P52):` | ✓ | ✓ | ✗ |
| 262 | `Pointer to terrain movement cost table` | ✓ | ✓ | ✗ |
| 265 | `Jump` | ✓ | ✓ | ✗ |
| 268 | `Terrain Avoid (P56):` | ✓ | ✓ | ✗ |
| 271 | `Jump` | ✓ | ✓ | ✗ |
| 273 | `Terrain Def (P60):` | ✓ | ✓ | ✗ |
| 276 | `Jump` | ✓ | ✓ | ✗ |
| 279 | `Terrain Res (P64):` | ✓ | ✓ | ✗ |
| 282 | `Jump` | ✓ | ✓ | ✗ |
| 285 | `Unknown u32 field at offset 68 (D68)` | ✓ | ✓ | ✗ |
| 292 | `Growth Simulator` | ✓ | ✓ | ✗ |
| 296 | `Calculate Growth` | ✓ | ✓ | ✗ |
| 297 | `Sim Level:` | ✓ | ✓ | ✗ |
| 307 | `Export/Import Options` | ✓ | ✓ | ✗ |
| 312 | `Use Clipboard` | ✓ | ✓ | ✗ |
| 314 | `Include Header` | ✓ | ✓ | ✗ |
| 316 | `Include UID` | ✓ | ✓ | ✗ |
| 318 | `Include Name` | ✓ | ✓ | ✗ |
| 320 | `Include Base Stats` | ✓ | ✓ | ✗ |
| 322 | `Include Growths` | ✓ | ✓ | ✗ |
| 324 | `Include Wep Level` | ✓ | ✓ | ✗ |
| 326 | `Growths as Decimal` | ✓ | ✓ | ✗ |
| 332 | `Write` | ✓ | ✓ | ✗ |
| 334 | `Export All` | ✓ | ✓ | ✗ |
| 335 | `Export all classes to a CSV file or clipboard` | ✓ | ✓ | ✗ |
| 336 | `Export Selected` | ✓ | ✓ | ✗ |
| 337 | `Export the selected class to a CSV file or clipboard` | ✓ | ✓ | ✗ |
| 338 | `Import All` | ✓ | ✓ | ✗ |
| 339 | `Import all classes from a CSV file or clipboard` | ✓ | ✓ | ✗ |
| 340 | `Import Selected` | ✓ | ✓ | ✗ |
| 341 | `Import the selected class from a CSV file or clipboard` | ✓ | ✓ | ✗ |
...
| 72 | `Skill Detail` | ✓ | ✓ | ✗ |
| 75 | `Skill Configuration (FE8N v3)` | ✓ | ✓ | ✗ |
| 82 | `Skill system editors require the FE8N v3 skill patch to be installed.\r\nUse the Patch Manager to install it first.` | ✓ | ✓ | ✗ |
| 89 | `Icon` | ✓ | ✓ | ✗ |
| 97 | `Image Import` | ✓ | ✓ | ✗ |
| 99 | `Pending Core extraction - tracked by #500.` | ✓ | ✓ | ✗ |
| 102 | `Image Export` | ✓ | ✓ | ✗ |
| 104 | `Pending Core extraction - tracked by #500.` | ✓ | ✓ | ✗ |
| 115 | `Text Detail` | ✓ | ✓ | ✗ |
| 130 | `Palette` | ✓ | ✓ | ✗ |
| 146 | `Unit Skill Pointer` | ✓ | ✓ | ✗ |
| 153 | `Per-skill unit sub-list (KnownGap: tracked by #374)` | ✓ | ✓ | ✗ |
| 162 | `Class Skill Pointer` | ✓ | ✓ | ✗ |
| 169 | `Per-skill class sub-list (KnownGap: tracked by #374)` | ✓ | ✓ | ✗ |
| 178 | `Item Skill Pointer` | ✓ | ✓ | ✗ |
| 185 | `When this item is held, the skill activates (KnownGap: tracked by #374)` | ✓ | ✓ | ✗ |
| 194 | `Item2 Skill Pointer` | ✓ | ✓ | ✗ |
| 201 | `When this item is equipped as weapon, the skill activates (KnownGap: tracked by #374)` | ✓ | ✓ | ✗ |
| 210 | `Composite Skill Pointer` | ✓ | ✓ | ✗ |
| 217 | `Adds the effect of another skill (KnownGap: tracked by #374)` | ✓ | ✓ | ✗ |
| 225 | `Move to COMBAT_ART` | ✓ | ✓ | ✗ |
| 227 | `PatchManagerView does not yet expose JumpToSelectStruct (tracked by #374).` | ✓ | ✓ | ✗ |
| 234 | `Animation` | ✓ | ✓ | ✗ |
| 247 | `Animation Import` | ✓ | ✓ | ✗ |
| 249 | `Pending Core extraction - tracked by #500.` | ✓ | ✓ | ✗ |
| 252 | `Animation Export` | ✓ | ✓ | ✗ |
| 254 | `Pending Core extraction - tracked by #500.` | ✓ | ✓ | ✗ |
| 261 | `Display example` | ✓ | ✓ | ✗ |
| 265 | `Zoom` | ✓ | ✓ | ✗ |
| 273 | `Zoomed` | ✓ | ✓ | ✗ |
| 274 | `Original size` | ✓ | ✓ | ✗ |
| 278 | `Frame` | ✓ | ✓ | ✗ |
| 291 | `Editor` | ✓ | ✓ | ✗ |
| 293 | `Pending Core extraction - tracked by #500.` | ✓ | ✓ | ✗ |
| 302 | `Unit Skill List` | ✓ | ✓ | ✗ |
| 304 | `Unit Skill Sub-list` | ✓ | ✓ | ✗ |
| 311 | `Per-skill unit sub-list editing is not yet implemented in Avalonia.` | ✓ | ✓ | ✗ |
| 314 | `Use the WinForms editor to assign units to a skill.` | ✓ | ✓ | ✗ |
| 317 | `KnownGap: depends on InputFormRef auto-wiring (tracked by #374).` | ✓ | ✓ | ✗ |
| 321 | `Sub-list base: -` | ✓ | ✓ | ✗ |
| 323 | `Entry count: -` | ✓ | ✓ | ✗ |
| 329 | `Class Skill List` | ✓ | ✓ | ✗ |
| 331 | `Class Skill Sub-list` | ✓ | ✓ | ✗ |
| 338 | `Per-skill class sub-list editing is not yet implemented in Avalonia.` | ✓ | ✓ | ✗ |
| 341 | `Use the WinForms editor to assign classes to a skill.` | ✓ | ✓ | ✗ |
| 344 | `KnownGap: depends on InputFormRef auto-wiring (tracked by #374).` | ✓ | ✓ | ✗ |
| 348 | `Sub-list base: -` | ✓ | ✓ | ✗ |
| 350 | `Entry count: -` | ✓ | ✓ | ✗ |
| 356 | `Item Skill List` | ✓ | ✓ | ✗ |
| 358 | `Item Skill Sub-list` | ✓ | ✓ | ✗ |
| 365 | `Per-skill item sub-list editing is not yet implemented in Avalonia.` | ✓ | ✓ | ✗ |
| 368 | `Use the WinForms editor to assign held items to a skill.` | ✓ | ✓ | ✗ |
| 371 | `KnownGap: depends on InputFormRef auto-wiring (tracked by #374).` | ✓ | ✓ | ✗ |
| 375 | `Sub-list base: -` | ✓ | ✓ | ✗ |
| 377 | `Entry count: -` | ✓ | ✓ | ✗ |
| 383 | `Item2 Skill List` | ✓ | ✓ | ✗ |
| 385 | `Item2 Skill Sub-list` | ✓ | ✓ | ✗ |
| 392 | `Per-skill Item2 sub-list editing is not yet implemented in Avalonia.` | ✓ | ✓ | ✗ |
| 395 | `Use the WinForms editor to assign weapon-equipped items to a skill.` | ✓ | ✓ | ✗ |
| 398 | `KnownGap: depends on InputFormRef auto-wiring (tracked by #374).` | ✓ | ✓ | ✗ |
| 402 | `Sub-list base: -` | ✓ | ✓ | ✗ |
| 404 | `Entry count: -` | ✓ | ✓ | ✗ |
| 410 | `Composite Skill List` | ✓ | ✓ | ✗ |
| 412 | `Composite Skill Sub-list` | ✓ | ✓ | ✗ |
| 419 | `Per-skill composite-skill sub-list editing is not yet implemented in Avalonia.` | ✓ | ✓ | ✗ |
| 422 | `Use the WinForms editor to add other skills as composite effects.` | ✓ | ✓ | ✗ |
| 425 | `KnownGap: depends on InputFormRef auto-wiring (tracked by #374).` | ✓ | ✓ | ✗ |
| 429 | `Sub-list base: -` | ✓ | ✓ | ✗ |
| 431 | `Entry count: -` | ✓ | ✓ | ✗ |
...
| 102 | `Start` | ✓ | ✓ | ✗ |
| 113 | `Step1Page` | ✓ | ✓ | ✗ |
| 117 | `Specify an emulator to use for testing.\nPress F5 in FEBuilderGBA to launch the emulator and test the ROM.` | ✓ | ✓ | ✗ |
| 120 | `Step 1/6` | ✓ | ✓ | ✗ |
| 125 | `Emulator:` | ✓ | ✓ | ✗ |
| 130 | `Browse` | ✓ | ✓ | ✗ |
| 136 | `Next` | ✓ | ✓ | ✗ |
| 143 | `Download a stable version of VBA-M` | ✓ | ✓ | ✗ |
| 152 | `Download mGBA` | ✓ | ✓ | ✗ |
| 159 | `Previous` | ✓ | ✓ | ✗ |
| 170 | `Step2Page` | ✓ | ✓ | ✗ |
| 174 | `Configure Event Assembler (EA).\nSome patches are written in EA and require it to install.` | ✓ | ✓ | ✗ |
| 177 | `Step 2/6` | ✓ | ✓ | ✗ |
| 187 | `Browse` | ✓ | ✓ | ✗ |
| 193 | `Next` | ✓ | ✓ | ✗ |
| 200 | `Download the latest EA` | ✓ | ✓ | ✗ |
| 209 | `Skip` | ✓ | ✓ | ✗ |
| 214 | `Previous` | ✓ | ✓ | ✗ |
| 225 | `Step3Page` | ✓ | ✓ | ✗ |
| 229 | `Configure Sappy (or VG Music Studio).\nWhen Sappy is configured, the song-preview button can play music.` | ✓ | ✓ | ✗ |
| 232 | `Step 3/6` | ✓ | ✓ | ✗ |
| 237 | `Sappy:` | ✓ | ✓ | ✗ |
| 242 | `Browse` | ✓ | ✓ | ✗ |
| 248 | `Next` | ✓ | ✓ | ✗ |
| 255 | `Download Sappy` | ✓ | ✓ | ✗ |
| 264 | `Download VG Music Studio` | ✓ | ✓ | ✗ |
| 273 | `Skip Sappy` | ✓ | ✓ | ✗ |
| 278 | `Previous` | ✓ | ✓ | ✗ |
| 289 | `Step4Page` | ✓ | ✓ | ✗ |
| 293 | `Configure the development environment.\nInstalling the toolchain enables ASM development and debugging.` | ✓ | ✓ | ✗ |
| 296 | `Step 4/6` | ✓ | ✓ | ✗ |
| 301 | `Debugger:` | ✓ | ✓ | ✗ |
| 306 | `Browse` | ✓ | ✓ | ✗ |
| 312 | `Assembler:` | ✓ | ✓ | ✗ |
| 317 | `Browse` | ✓ | ✓ | ✗ |
| 323 | `Next` | ✓ | ✓ | ✗ |
| 330 | `Download the latest tools automatically` | ✓ | ✓ | ✗ |
| 339 | `Skip` | ✓ | ✓ | ✗ |
| 344 | `Previous` | ✓ | ✓ | ✗ |
| 355 | `Step5Page` | ✓ | ✓ | ✗ |
| 359 | `Configure utilities used to convert music.` | ✓ | ✓ | ✗ |
| 362 | `Step 5/6` | ✓ | ✓ | ✗ |
| 367 | `gba mus riper` | ✓ | ✓ | ✗ |
| 372 | `Browse` | ✓ | ✓ | ✗ |
| 383 | `Browse` | ✓ | ✓ | ✗ |
...
| 394 | `Browse` | ✓ | ✓ | ✗ |
| 400 | `Next` | ✓ | ✓ | ✗ |
| 407 | `Download the latest tools automatically` | ✓ | ✓ | ✗ |
| 416 | `Skip` | ✓ | ✓ | ✗ |
| 421 | `Previous` | ✓ | ✓ | ✗ |
| 432 | `Step6Page` | ✓ | ✓ | ✗ |
| 436 | `Configure Git (version control).\nGit is used to keep config/patch2 patch data up to date.\nInstalling it makes pulling the latest patches easy.` | ✓ | ✓ | ✗ |
| 439 | `Step 6/6` | ✓ | ✓ | ✗ |
| 449 | `Browse` | ✓ | ✓ | ✗ |
| 455 | `Finish setup` | ✓ | ✓ | ✗ |
| 462 | `Download and install the latest Git automatically` | ✓ | ✓ | ✗ |
| 471 | `Skip` | ✓ | ✓ | ✗ |
| 476 | `Previous` | ✓ | ✓ | ✗ |
| 487 | `SettingNowPage` | ✓ | ✓ | ✗ |
| 489 | `Please wait...` | ✓ | ✓ | ✗ |
| 492 | `Downloading required programs and configuring settings.` | ✓ | ✓ | ✗ |
| 506 | `EndPage` | ✓ | ✓ | ✗ |
| 508 | `All settings complete.` | ✓ | ✓ | ✗ |
| 517 | `Setup is complete. The wizard saved your tool paths and preferences.\n\nYou can change these at any time from Menu -> Options.\n\nPress Finish to close this wizard.` | ✓ | ✓ | ✗ |
| 520 | `Finish` | ✓ | ✓ | ✗ |
...
| 80 | `Map Chip Preview` | ✓ | ✓ | ✗ |
| 88 | `Image Export` | ✓ | ✓ | ✗ |
| 90 | `Pending Core extraction - tracked by #374.` | ✓ | ✓ | ✗ |
| 92 | `Image Import` | ✓ | ✓ | ✗ |
| 94 | `Pending Core extraction - tracked by #374.` | ✓ | ✓ | ✗ |
| 96 | `Map Chip Save` | ✓ | ✓ | ✗ |
| 98 | `Pending Core extraction - tracked by #374.` | ✓ | ✓ | ✗ |
| 100 | `Map Chip Load` | ✓ | ✓ | ✗ |
| 102 | `Pending Core extraction - tracked by #374.` | ✓ | ✓ | ✗ |
| 104 | `UNDO` | ✓ | ✓ | ✗ |
| 106 | `Pending Core extraction - tracked by #374.` | ✓ | ✓ | ✗ |
| 108 | `REDO` | ✓ | ✓ | ✗ |
| 110 | `Pending Core extraction - tracked by #374.` | ✓ | ✓ | ✗ |
| 112 | `Write` | ✓ | ✓ | ✗ |
| 123 | `Palette` | ✓ | ✓ | ✗ |
| 126 | `Palette` | ✓ | ✓ | ✗ |
| 130 | `Palette No:` | ✓ | ✓ | ✗ |
...
| 146 | `No Fog` | ✓ | ✓ | ✗ |
| 243 | `Palette Export` | ✓ | ✓ | ✗ |
| 245 | `Pending Core extraction - tracked by #374.` | ✓ | ✓ | ✗ |
| 247 | `Palette Import` | ✓ | ✓ | ✗ |
| 249 | `Pending Core extraction - tracked by #374.` | ✓ | ✓ | ✗ |
| 251 | `Clipboard` | ✓ | ✓ | ✗ |
| 253 | `Pending Core extraction - tracked by #374.` | ✓ | ✓ | ✗ |
| 255 | `Palette Write` | ✓ | ✓ | ✗ |
| 257 | `Pending Core extraction (palette PLIST allocation) - tracked by #374.` | ✓ | ✓ | ✗ |
| 267 | `Chipset` | ✓ | ✓ | ✗ |
| 270 | `Chipset` | ✓ | ✓ | ✗ |
| 278 | `TSA grids require LZ77 + CONFIG PLIST extraction (KnownGap: tracked by #374).` | ✓ | ✓ | ✗ |
| 282 | `Chipset Config Address:` | ✓ | ✓ | ✗ |
| 288 | `Chipset No:` | ✓ | ✓ | ✗ |
| 294 | `Terrain Type:` | ✓ | ✓ | ✗ |
| 299 | `Pending Core extraction (terrain list from LZ77 ChipsetData) - tracked by #374.` | ✓ | ✓ | ✗ |
| 307 | `Top-Left` | ✓ | ✓ | ✗ |
| 313 | `Palette` | ✓ | ✓ | ✗ |
| 315 | `Flip` | ✓ | ✓ | ✗ |
| 325 | `Top-Right` | ✓ | ✓ | ✗ |
...
| 369 | `Flip` | ✓ | ✓ | ✗ |
| 379 | `Copy Tile (Alt+T)` | ✓ | ✓ | ✗ |
| 381 | `Pending Core extraction - tracked by #374.` | ✓ | ✓ | ✗ |
| 383 | `Copy Type (Alt+C)` | ✓ | ✓ | ✗ |
| 385 | `Pending Core extraction - tracked by #374.` | ✓ | ✓ | ✗ |
| 387 | `Paste (Alt+V)` | ✓ | ✓ | ✗ |
| 389 | `Pending Core extraction - tracked by #374.` | ✓ | ✓ | ✗ |
| 391 | `Config Write` | ✓ | ✓ | ✗ |
| 393 | `Pending Core extraction (LZ77 ChipsetData + CONFIG PLIST) - tracked by #374.` | ✓ | ✓ | ✗ |
...
| 67 | `Filter Name` | ✓ | ✓ | ✗ |
| 70 | `List Expand` | ✓ | ✓ | ✗ |
| 72 | `Pending Core extraction - tracked by #500.` | ✓ | ✓ | ✗ |
| 86 | `Skill Detail` | ✓ | ✓ | ✗ |
| 89 | `Skill Configuration (FE8N)` | ✓ | ✓ | ✗ |
| 96 | `Skill system editors require a compatible skill patch to be installed.\r\nUse the Patch Manager to install a skill system patch first.\r\n\r\nSupported skill systems: CSkillSys, FE8N Skill System` | ✓ | ✓ | ✗ |
| 103 | `Icon` | ✓ | ✓ | ✗ |
| 111 | `Image Import` | ✓ | ✓ | ✗ |
| 113 | `Pending Core extraction - tracked by #500.` | ✓ | ✓ | ✗ |
| 116 | `Image Export` | ✓ | ✓ | ✗ |
| 118 | `Pending Core extraction - tracked by #500.` | ✓ | ✓ | ✗ |
| 129 | `Icon ID` | ✓ | ✓ | ✗ |
| 136 | `W0 - icon address = iconBase + 128 * IconId` | ✓ | ✓ | ✗ |
| 145 | `Skill Name` | ✓ | ✓ | ✗ |
| 160 | `Description` | ✓ | ✓ | ✗ |
| 170 | `Icon Display Condition` | ✓ | ✓ | ✗ |
| 180 | `Caution: the icon display condition only controls whether the icon shows in the menu - it does NOT enable the skill itself. The condition fields hold a Unit ID, a Class ID, a stat (1-4), or an Item ID… (truncated)` | ✓ | ✓ | ✗ |
| 187 | `Unit` | ✓ | ✓ | ✗ |
| 210 | `Class` | ✓ | ✓ | ✗ |
| 233 | `Item` | ✓ | ✓ | ✗ |
| 256 | `Animation` | ✓ | ✓ | ✗ |
| 263 | `Animation Import` | ✓ | ✓ | ✗ |
| 265 | `Pending Core extraction - tracked by #500.` | ✓ | ✓ | ✗ |
| 268 | `Animation Export` | ✓ | ✓ | ✗ |
| 270 | `Pending Core extraction - tracked by #500.` | ✓ | ✓ | ✗ |
| 273 | `Editor` | ✓ | ✓ | ✗ |
| 275 | `Pending Core extraction - tracked by #500.` | ✓ | ✓ | ✗ |
| 283 | `Unit Skill List` | ✓ | ✓ | ✗ |
| 285 | `Unit Skill Sub-list` | ✓ | ✓ | ✗ |
| 292 | `Per-skill unit sub-list editing is not yet implemented in Avalonia.` | ✓ | ✓ | ✗ |
| 295 | `Use the WinForms editor to assign units to a skill.` | ✓ | ✓ | ✗ |
| 298 | `KnownGap: depends on InputFormRef auto-wiring (tracked by #374).` | ✓ | ✓ | ✗ |
| 302 | `Sub-list base: -` | ✓ | ✓ | ✗ |
| 304 | `Entry count: -` | ✓ | ✓ | ✗ |
| 310 | `Class Skill List` | ✓ | ✓ | ✗ |
| 312 | `Class Skill Sub-list` | ✓ | ✓ | ✗ |
| 319 | `Per-skill class sub-list editing is not yet implemented in Avalonia.` | ✓ | ✓ | ✗ |
| 322 | `Use the WinForms editor to assign classes to a skill.` | ✓ | ✓ | ✗ |
| 325 | `KnownGap: depends on InputFormRef auto-wiring (tracked by #374).` | ✓ | ✓ | ✗ |
| 329 | `Sub-list base: -` | ✓ | ✓ | ✗ |
| 331 | `Entry count: -` | ✓ | ✓ | ✗ |
| 337 | `Item Skill List` | ✓ | ✓ | ✗ |
| 339 | `Item Skill Sub-list` | ✓ | ✓ | ✗ |
| 346 | `Per-skill item sub-list editing is not yet implemented in Avalonia.` | ✓ | ✓ | ✗ |
| 349 | `Use the WinForms editor to assign items to a skill.` | ✓ | ✓ | ✗ |
| 352 | `KnownGap: depends on InputFormRef auto-wiring (tracked by #374).` | ✓ | ✓ | ✗ |
| 356 | `Sub-list base: -` | ✓ | ✓ | ✗ |
| 358 | `Entry count: -` | ✓ | ✓ | ✗ |
| 364 | `Other Skill List` | ✓ | ✓ | ✗ |
| 366 | `Other Skill Sub-list` | ✓ | ✓ | ✗ |
| 373 | `Per-skill 'other' sub-list editing is not yet implemented in Avalonia.` | ✓ | ✓ | ✗ |
| 376 | `The N03 sub-tab in WF holds 16 generic bytes (B16..B31) with no fixed semantics; the WF UI exposes them as unlabeled NumericUpDowns. The Avalonia view surfaces the base address so power users can drop… (truncated)` | ✓ | ✓ | ✗ |
| 379 | `KnownGap: depends on InputFormRef auto-wiring (tracked by #374).` | ✓ | ✓ | ✗ |
| 383 | `Sub-list base: -` | ✓ | ✓ | ✗ |
| 385 | `Entry count: -` | ✓ | ✓ | ✗ |
...
| 59 | `Pending Core extraction - tracked by #500.` | ✓ | ✓ | ✗ |
| 72 | `Skill Detail` | ✓ | ✓ | ✗ |
| 75 | `Skill Configuration (FE8N v2)` | ✓ | ✓ | ✗ |
| 82 | `Skill system editors require the FE8N v2 skill patch to be installed.\r\nUse the Patch Manager to install it first.` | ✓ | ✓ | ✗ |
| 89 | `Icon` | ✓ | ✓ | ✗ |
| 97 | `Image Import` | ✓ | ✓ | ✗ |
| 99 | `Pending Core extraction - tracked by #500.` | ✓ | ✓ | ✗ |
| 102 | `Image Export` | ✓ | ✓ | ✗ |
...
| 169 | `Per-skill class sub-list (KnownGap: tracked by #374)` | ✓ | ✓ | ✗ |
| 178 | `Item Skill Pointer` | ✓ | ✓ | ✗ |
| 185 | `Per-skill item sub-list (KnownGap: tracked by #374)` | ✓ | ✓ | ✗ |
| 195 | `Item2 Skill Pointer` | ✓ | ✓ | ✗ |
| 202 | `Sizeof-20+ layout only (KnownGap: tracked by #374)` | ✓ | ✓ | ✗ |
| 211 | `Animation` | ✓ | ✓ | ✗ |
| 224 | `Animation Import` | ✓ | ✓ | ✗ |
| 226 | `Pending Core extraction - tracked by #500.` | ✓ | ✓ | ✗ |
| 229 | `Animation Export` | ✓ | ✓ | ✗ |
| 231 | `Pending Core extraction - tracked by #500.` | ✓ | ✓ | ✗ |
| 238 | `Display example` | ✓ | ✓ | ✗ |
| 242 | `Zoom` | ✓ | ✓ | ✗ |
| 250 | `Zoomed` | ✓ | ✓ | ✗ |
| 251 | `Original size` | ✓ | ✓ | ✗ |
...
| 270 | `Pending Core extraction - tracked by #500.` | ✓ | ✓ | ✗ |
| 279 | `Unit Skill List` | ✓ | ✓ | ✗ |
| 281 | `Unit Skill Sub-list` | ✓ | ✓ | ✗ |
| 288 | `Per-skill unit sub-list editing is not yet implemented in Avalonia.` | ✓ | ✓ | ✗ |
| 291 | `Use the WinForms editor to assign units to a skill.` | ✓ | ✓ | ✗ |
| 294 | `KnownGap: depends on InputFormRef auto-wiring (tracked by #374).` | ✓ | ✓ | ✗ |
| 298 | `Sub-list base: -` | ✓ | ✓ | ✗ |
| 300 | `Entry count: -` | ✓ | ✓ | ✗ |
| 306 | `Class Skill List` | ✓ | ✓ | ✗ |
| 308 | `Class Skill Sub-list` | ✓ | ✓ | ✗ |
| 315 | `Per-skill class sub-list editing is not yet implemented in Avalonia.` | ✓ | ✓ | ✗ |
| 318 | `Use the WinForms editor to assign classes to a skill.` | ✓ | ✓ | ✗ |
| 321 | `KnownGap: depends on InputFormRef auto-wiring (tracked by #374).` | ✓ | ✓ | ✗ |
| 325 | `Sub-list base: -` | ✓ | ✓ | ✗ |
| 327 | `Entry count: -` | ✓ | ✓ | ✗ |
| 333 | `Item Skill List` | ✓ | ✓ | ✗ |
| 335 | `Item Skill Sub-list` | ✓ | ✓ | ✗ |
| 342 | `Per-skill item sub-list editing is not yet implemented in Avalonia.` | ✓ | ✓ | ✗ |
| 345 | `Use the WinForms editor to assign items to a skill.` | ✓ | ✓ | ✗ |
| 348 | `KnownGap: depends on InputFormRef auto-wiring (tracked by #374).` | ✓ | ✓ | ✗ |
| 352 | `Sub-list base: -` | ✓ | ✓ | ✗ |
| 354 | `Entry count: -` | ✓ | ✓ | ✗ |
| 360 | `Item2 Skill List` | ✓ | ✓ | ✗ |
| 362 | `Item2 Skill Sub-list (sizeof-20+ layout)` | ✓ | ✓ | ✗ |
| 369 | `Per-skill Item2 sub-list editing is not yet implemented in Avalonia.` | ✓ | ✓ | ✗ |
| 372 | `Use the WinForms editor to assign second-item-skills to a skill.` | ✓ | ✓ | ✗ |
| 375 | `KnownGap: depends on InputFormRef auto-wiring (tracked by #374).` | ✓ | ✓ | ✗ |
| 379 | `Sub-list base: -` | ✓ | ✓ | ✗ |
| 381 | `Entry count: -` | ✓ | ✓ | ✗ |
...
| 40 | `Selected: 00` | ✓ | ✓ | ✗ |
| 43 | `Canvas:` | ✓ | ✓ | ✗ |
| 59 | `Chipset Preview (deferred KnownGap): live LZ77 decode + flip permutations are WinForms-coupled (ImageUtil.BitBlt). Use the WinForms editor to paint TSA cells.` | ✓ | ✓ | ✗ |
| 61 | `KnownGap: chipset thumbnail rendering is WinForms-coupled (#393).` | ✓ | ✓ | ✗ |
| 64 | `Battle Preview (deferred KnownGap): rendering the 32x20 TSA grid with the live palette requires System.Drawing + ImageUtil.BitBlt. The numeric fields and palette/image pointer write paths in this edit… (truncated)` | ✓ | ✓ | ✗ |
| 66 | `KnownGap: battle-screen bitmap rendering is WinForms-coupled (#393).` | ✓ | ✓ | ✗ |
| 75 | `TSA1 Address` | ✓ | ✓ | ✗ |
| 89 | `Palette` | ✓ | ✓ | ✗ |
| 95 | `Palette Address` | ✓ | ✓ | ✗ |
| 99 | `Palette Type` | ✓ | ✓ | ✗ |
...
| 110 | `Undo` | ✓ | ✓ | ✗ |
| 113 | `Redo` | ✓ | ✓ | ✗ |
| 115 | `KnownGap: local palette-edit redo (PaletteFormRef redo buffer) is WinForms-coupled (#393). Use the main ROM-level Undo via the toolbar.` | ✓ | ✓ | ✗ |
| 345 | `Main Image` | ✓ | ✓ | ✗ |
| 349 | `Tile1` | ✓ | ✓ | ✗ |
| 351 | `Tile2` | ✓ | ✓ | ✗ |
| 353 | `Tile3` | ✓ | ✓ | ✗ |
...
| 360 | `Image` | ✓ | ✓ | ✗ |
| 365 | `Image Import` | ✓ | ✓ | ✗ |
| 366 | `KnownGap: per-image LZ77 Import (ImageFormRef.ImportFilenameDialog + ImageUtil.ImageToByte16Tile) is WinForms-coupled (#393).` | ✓ | ✓ | ✗ |
| 368 | `Image Export` | ✓ | ✓ | ✗ |
| 369 | `KnownGap: per-image PNG Export (ImageFormRef.ExportImage) is WinForms-coupled (#393).` | ✓ | ✓ | ✗ |
| 373 | `Image1 Preview (deferred KnownGap): per-tile LZ77 decompress + palette blit is WinForms-coupled (#393).` | ✓ | ✓ | ✗ |
| 381 | `Left Side` | ✓ | ✓ | ✗ |
| 385 | `Name` | ✓ | ✓ | ✗ |
| 391 | `Image Import` | ✓ | ✓ | ✗ |
| 392 | `KnownGap: per-image LZ77 Import is WinForms-coupled (#393).` | ✓ | ✓ | ✗ |
| 394 | `Image Export` | ✓ | ✓ | ✗ |
| 395 | `KnownGap: per-image PNG Export is WinForms-coupled (#393).` | ✓ | ✓ | ✗ |
| 398 | `Image2 Preview (deferred)` | ✓ | ✓ | ✗ |
| 403 | `Item` | ✓ | ✓ | ✗ |
| 409 | `Image Import` | ✓ | ✓ | ✗ |
| 410 | `KnownGap: per-image LZ77 Import is WinForms-coupled (#393).` | ✓ | ✓ | ✗ |
| 412 | `Image Export` | ✓ | ✓ | ✗ |
| 413 | `KnownGap: per-image PNG Export is WinForms-coupled (#393).` | ✓ | ✓ | ✗ |
| 416 | `Image3 Preview (deferred)` | ✓ | ✓ | ✗ |
| 424 | `Right Side` | ✓ | ✓ | ✗ |
| 428 | `Name` | ✓ | ✓ | ✗ |
| 434 | `Image Import` | ✓ | ✓ | ✗ |
| 435 | `KnownGap: per-image LZ77 Import is WinForms-coupled (#393).` | ✓ | ✓ | ✗ |
| 437 | `Image Export` | ✓ | ✓ | ✗ |
| 438 | `KnownGap: per-image PNG Export is WinForms-coupled (#393).` | ✓ | ✓ | ✗ |
| 441 | `Image4 Preview (deferred)` | ✓ | ✓ | ✗ |
| 446 | `Item` | ✓ | ✓ | ✗ |
| 452 | `Image Import` | ✓ | ✓ | ✗ |
| 453 | `KnownGap: per-image LZ77 Import is WinForms-coupled (#393).` | ✓ | ✓ | ✗ |
| 455 | `Image Export` | ✓ | ✓ | ✗ |
| 456 | `KnownGap: per-image PNG Export is WinForms-coupled (#393).` | ✓ | ✓ | ✗ |
| 459 | `Image5 Preview (deferred)` | ✓ | ✓ | ✗ |
| 467 | `Import/Export` | ✓ | ✓ | ✗ |
| 470 | `Bulk import/export the battle screen as a single image. TSA layout means common tiles must be deduplicated.` | ✓ | ✓ | ✗ |
| 474 | `Image Import` | ✓ | ✓ | ✗ |
| 475 | `KnownGap: bulk image Import requires ImageFormRef.ImportFilenameDialog + ImageUtil.ImageToByteKeepTSA (WinForms-coupled, #393).` | ✓ | ✓ | ✗ |
| 477 | `Image Export` | ✓ | ✓ | ✗ |
| 478 | `KnownGap: bulk image Export requires ImageFormRef.ExportImage + live battle-screen bitmap (WinForms-coupled, #393).` | ✓ | ✓ | ✗ |
| 480 | `Undo` | ✓ | ✓ | ✗ |
| 483 | `Redo` | ✓ | ✓ | ✗ |
| 484 | `KnownGap: local TSA redo buffer is WinForms-coupled. Use the main ROM-level Undo via the toolbar (#393).` | ✓ | ✓ | ✗ |
...
| 123 | `Write` | ✓ | ✓ | ✗ |
| 125 | `Expand List` | ✓ | ✓ | ✗ |
| 143 | `Probability Table` | ✓ | ✓ | ✗ |
| 150 | `Probability Table` | ✓ | ✓ | ✗ |
| 154 | `Read Start:` | ✓ | ✓ | ✗ |
| 158 | `Count:` | ✓ | ✓ | ✗ |
| 163 | `Reload` | ✓ | ✓ | ✗ |
| 169 | `Address:` | ✓ | ✓ | ✗ |
| 172 | `Size:` | ✓ | ✓ | ✗ |
| 176 | `Selected Address:` | ✓ | ✓ | ✗ |
| 189 | `Probability 1:` | ✓ | ✓ | ✗ |
| 194 | `Probability 2:` | ✓ | ✓ | ✗ |
| 199 | `Probability 3:` | ✓ | ✓ | ✗ |
| 204 | `Probability 4:` | ✓ | ✓ | ✗ |
...
| 260 | `Address:` | ✓ | ✓ | ✗ |
| 263 | `Size:` | ✓ | ✓ | ✗ |
| 267 | `Selected Address:` | ✓ | ✓ | ✗ |
| 287 | `Holdings Set 1` | ✓ | ✓ | ✗ |
| 289 | `Slot` | ✓ | ✓ | ✗ |
| 290 | `Candidate` | ✓ | ✓ | ✗ |
| 292 | `Probability` | ✓ | ✓ | ✗ |
| 293 | `Item Probability` | ✓ | ✓ | ✗ |
| 295 | `Slot 1` | ✓ | ✓ | ✗ |
| 306 | `Slot 2` | ✓ | ✓ | ✗ |
| 317 | `Slot 3` | ✓ | ✓ | ✗ |
| 328 | `Slot 4` | ✓ | ✓ | ✗ |
...
| 21 | `Reload` | ✓ | ✓ | ✗ |
| 23 | `Expand List` | ✓ | ✓ | ✗ |
| 24 | `Pending Core extraction (list expansion is WinForms-only).` | ✓ | ✓ | ✗ |
| 25 | `Filter` | ✓ | ✓ | ✗ |
| 41 | `Address` | ✓ | ✓ | ✗ |
| 45 | `Size:` | ✓ | ✓ | ✗ |
| 48 | `Selected Address:` | ✓ | ✓ | ✗ |
...
| 60 | `Type:` | ✓ | ✓ | ✗ |
| 64 | `Info` | ✓ | ✓ | ✗ |
| 67 | `Export Instrument` | ✓ | ✓ | ✗ |
| 69 | `Pending Core extraction (instrument-set shell file dialog is WinForms-only).` | ✓ | ✓ | ✗ |
| 71 | `Import Instrument` | ✓ | ✓ | ✗ |
| 73 | `Pending Core extraction (instrument-set shell file dialog is WinForms-only).` | ✓ | ✓ | ✗ |
| 76 | `Header Byte:` | ✓ | ✓ | ✗ |
| 80 | `More Info:` | ✓ | ✓ | ✗ |
| 98 | `DirectSound` | ✓ | ✓ | ✗ |
| 133 | `Preview` | ✓ | ✓ | ✗ |
| 134 | `Pending Core extraction (Sappy emulator preview is WinForms-only).` | ✓ | ✓ | ✗ |
| 137 | `Pending Core extraction (wave Export shell dialog is WinForms-only).` | ✓ | ✓ | ✗ |
| 140 | `Pending Core extraction (wave Import shell dialog is WinForms-only).` | ✓ | ✓ | ✗ |
| 173 | `SquareWave1` | ✓ | ✓ | ✗ |
| 189 | `sweep` | ✓ | ✓ | ✗ |
| 192 | `sweeptime` | ✓ | ✓ | ✗ |
| 195 | `sweepshift` | ✓ | ✓ | ✗ |
...
| 390 | `Noise` | ✓ | ✓ | ✗ |
| 412 | `noisepattern` | ✓ | ✓ | ✗ |
| 447 | `DirectSound Fixed Freq` | ✓ | ✓ | ✗ |
| 482 | `Preview` | ✓ | ✓ | ✗ |
| 483 | `Pending Core extraction (Sappy emulator preview is WinForms-only).` | ✓ | ✓ | ✗ |
| 486 | `Pending Core extraction (wave Export shell dialog is WinForms-only).` | ✓ | ✓ | ✗ |
| 489 | `Pending Core extraction (wave Import shell dialog is WinForms-only).` | ✓ | ✓ | ✗ |
| 520 | `SquareWave3` | ✓ | ✓ | ✗ |
| 536 | `sweep` | ✓ | ✓ | ✗ |
| 539 | `sweeptime` | ✓ | ✓ | ✗ |
| 542 | `sweepshift` | ✓ | ✓ | ✗ |
...
| 731 | `Noise2` | ✓ | ✓ | ✗ |
| 753 | `noisepattern` | ✓ | ✓ | ✗ |
| 788 | `DirectSound Reverse` | ✓ | ✓ | ✗ |
| 823 | `Preview` | ✓ | ✓ | ✗ |
| 824 | `Pending Core extraction (Sappy emulator preview is WinForms-only).` | ✓ | ✓ | ✗ |
| 827 | `Pending Core extraction (wave Export shell dialog is WinForms-only).` | ✓ | ✓ | ✗ |
| 830 | `Pending Core extraction (wave Import shell dialog is WinForms-only).` | ✓ | ✓ | ✗ |
| 861 | `DirectSound Fixed Freq Reverse` | ✓ | ✓ | ✗ |
| 896 | `Preview` | ✓ | ✓ | ✗ |
| 897 | `Pending Core extraction (Sappy emulator preview is WinForms-only).` | ✓ | ✓ | ✗ |
| 900 | `Pending Core extraction (wave Export shell dialog is WinForms-only).` | ✓ | ✓ | ✗ |
| 903 | `Pending Core extraction (wave Import shell dialog is WinForms-only).` | ✓ | ✓ | ✗ |
| 934 | `Multi Sample` | ✓ | ✓ | ✗ |
| 971 | `DrumPart` | ✓ | ✓ | ✗ |
| 1029 | `SongData FingerPrint` | ✓ | ✓ | ✗ |
...
|---:|---|:---:|:---:|:---:|
| 14 | `Animations` | ✓ | ✓ | ✗ |
| 17 | `Select an animation to load its palette block.` | ✓ | ✓ | ✗ |
| 29 | `Palette Type` | ✓ | ✓ | ✗ |
| 33 | `Palette Write` | ✓ | ✓ | ✗ |
| 42 | `Zoom` | ✓ | ✓ | ✗ |
| 54 | `Address` | ✓ | ✓ | ✗ |
| 58 | `Source Pointer Slot:` | ✓ | ✓ | ✗ |
| 367 | `Clipboard` | ✓ | ✓ | ✗ |
| 370 | `Import Image` | ✓ | ✓ | ✗ |
| 372 | `Deferred KnownGap: Import requires the rendered sample bitmap (WinForms-coupled DrawBattleAnime via PaletteFormRef.MakePaletteBitmapToUIEx) (#399).` | ✓ | ✓ | ✗ |
| 374 | `Export Image` | ✓ | ✓ | ✗ |
| 376 | `Deferred KnownGap: Export requires the rendered sample bitmap (WinForms-coupled DrawBattleAnime via ImageFormRef.ExportImage) (#399).` | ✓ | ✓ | ✗ |
| 378 | `Undo` | ✓ | ✓ | ✗ |
| 381 | `Redo` | ✓ | ✓ | ✗ |
| 383 | `Deferred KnownGap: local palette-edit redo (PaletteFormRef redo buffer) is WinForms-coupled (#399). Use the main ROM-level Undo via the toolbar.` | ✓ | ✓ | ✗ |
| 396 | `Sample Preview (deferred): real battle-animation sample rendering is WinForms-coupled (DrawBattleAnime). Use the WinForms editor to preview palette changes against animated frames.` | ✓ | ✓ | ✗ |
...
| 87 | `Map Properties` | ✓ | ✓ | ✗ |
| 119 | `BGM / Music` | ✓ | ✓ | ✗ |
| 156 | `Breakable Wall HP / Difficulty Ratings` | ✓ | ✓ | ✗ |
| 216 | `Text IDs` | ✓ | ✓ | ✗ |
| 243 | `World Map / Event` | ✓ | ✓ | ✗ |
| 252 | `Chapter Number` | ✓ | ✓ | ✗ |
| 276 | `Victory BGM` | ✓ | ✓ | ✗ |
...
| File | Line | Element | Attribute | Literal |
|---|---:|---|---|---|
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 10 | `TextBlock` | `Text` | `先頭アドレス` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 11 | `TextBlock` | `Text` | `読込数` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 12 | `Button` | `Content` | `リストの拡張` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 13 | `Button` | `Content` | `再取得` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 23 | `TextBlock` | `Text` | `アドレス` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 29 | `TextBlock` | `Text` | `名前` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 33 | `TextBlock` | `Text` | `選択アドレス:` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 53 | `TextBlock` | `Text` | `オブジェクトタイプ(Plist)` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 56 | `TextBlock` | `Text` | `パレット(Plist)` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 59 | `TextBlock` | `Text` | `チップセットクタイプ(Plist)` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 62 | `TextBlock` | `Text` | `マップポインタ(Plist)` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 65 | `TextBlock` | `Text` | `タイルアニメーション1` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 68 | `TextBlock` | `Text` | `タイルアニメーション2` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 71 | `TextBlock` | `Text` | `マップ部分変更(Plist)` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 79 | `Button` | `Content` | `マップスタイルの変更` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 89 | `TextBlock` | `Text` | `霧レベル` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 92 | `TextBlock` | `Text` | `戦闘準備の有無` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 95 | `TextBlock` | `Text` | `章タイトル画像` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 98 | `TextBlock` | `Text` | `初期座標 X:` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 104 | `TextBlock` | `Text` | `天気` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 107 | `TextBlock` | `Text` | `戦闘背景` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 110 | `TextBlock` | `Text` | `ハードブースト` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 121 | `TextBlock` | `Text` | `味方フェーズBGM` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 130 | `TextBlock` | `Text` | `敵フェーズBGM` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 135 | `TextBlock` | `Text` | `友軍BGM` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 140 | `TextBlock` | `Text` | `ワールドマップBGM` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 145 | `TextBlock` | `Text` | `章オープニングBGM` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 160 | `TextBlock` | `Text` | `壊れる壁HP` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 167 | `TextBlock` | `Text` | `攻略評価` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 169 | `TextBlock` | `Text` | `攻略評価A` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 171 | `TextBlock` | `Text` | `攻略評価B` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 174 | `TextBlock` | `Text` | `攻略評価C` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 176 | `TextBlock` | `Text` | `攻略評価D` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 184 | `TextBlock` | `Text` | `経験評価` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 186 | `TextBlock` | `Text` | `経験評価A` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 188 | `TextBlock` | `Text` | `経験評価B` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 191 | `TextBlock` | `Text` | `経験評価C` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 193 | `TextBlock` | `Text` | `経験評価D` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 198 | `TextBlock` | `Text` | `戦力評価` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 200 | `TextBlock` | `Text` | `戦力評価A` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 202 | `TextBlock` | `Text` | `戦力評価B` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 205 | `TextBlock` | `Text` | `戦力評価C` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 207 | `TextBlock` | `Text` | `戦力評価D` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 218 | `TextBlock` | `Text` | `クリア条件(表示のみ)` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 222 | `TextBlock` | `Text` | `上の軍` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 226 | `TextBlock` | `Text` | `下の軍` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 230 | `TextBlock` | `Text` | `敵の軍旗` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 233 | `TextBlock` | `Text` | `章タイトル` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 245 | `TextBlock` | `Text` | `イベントID(Plist)` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 247 | `TextBlock` | `Text` | `ワールドマップ自動イベント` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 250 | `TextBlock` | `Text` | `ワールドマップ地名` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 255 | `TextBlock` | `Text` | `ワールドマップX` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 257 | `TextBlock` | `Text` | `ワールドマップY` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 260 | `TextBlock` | `Text` | `ワールドマップポイントX` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 262 | `TextBlock` | `Text` | `ワールドマップポイントY` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 267 | `Button` | `Content` | `マップエディタへJump` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 268 | `Button` | `Content` | `離脱ポイントへJump` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 278 | `TextBlock` | `Text` | `勝利BGMに変わる敵数` |
| `FEBuilderGBA.Avalonia/Views/MapSettingFE6View.axaml` | 285 | `Button` | `Content` | `書き込み (Write)` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 102 | `TextBlock` | `Text` | `基準ノート値` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 116 | `TextBlock` | `Text` | `PAN強制` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 119 | `TextBlock` | `Text` | `パンポット` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 128 | `TextBlock` | `Text` | `音データ` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 136 | `Button` | `Content` | `音データ 書出` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 139 | `Button` | `Content` | `音データ 読込` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 355 | `TextBlock` | `Text` | `波形データ` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 451 | `TextBlock` | `Text` | `基準ノート値` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 465 | `TextBlock` | `Text` | `PAN強制` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 468 | `TextBlock` | `Text` | `パンポット` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 477 | `TextBlock` | `Text` | `音データ` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 485 | `Button` | `Content` | `音データ 書出` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 488 | `Button` | `Content` | `音データ 読込` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 698 | `TextBlock` | `Text` | `波形データ` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 792 | `TextBlock` | `Text` | `基準ノート値` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 806 | `TextBlock` | `Text` | `PAN強制` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 809 | `TextBlock` | `Text` | `パンポット` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 818 | `TextBlock` | `Text` | `音データ` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 826 | `Button` | `Content` | `音データ 書出` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 829 | `Button` | `Content` | `音データ 読込` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 865 | `TextBlock` | `Text` | `基準ノート値` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 879 | `TextBlock` | `Text` | `PAN強制` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 882 | `TextBlock` | `Text` | `パンポット` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 891 | `TextBlock` | `Text` | `音データ` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 899 | `Button` | `Content` | `音データ 書出` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 902 | `Button` | `Content` | `音データ 読込` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 956 | `TextBlock` | `Text` | `楽器セット` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 962 | `TextBlock` | `Text` | `キー割り当て` |
| `FEBuilderGBA.Avalonia/Views/SongInstrumentView.axaml` | 993 | `TextBlock` | `Text` | `ドラムセット` |
| `FEBuilderGBA.Avalonia/Views/ToolInitWizardView.axaml` | 73 | `Button` | `Content` | `日本語` |
| `FEBuilderGBA.Avalonia/Views/ToolInitWizardView.axaml` | 77 | `Button` | `Content` | `中文` |
