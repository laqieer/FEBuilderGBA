...
| 296 | `Move Cost (P56):` | ✓ | ✓ | ✗ |
| 297 | `Pointer to terrain movement cost table` | ✓ | ✓ | ✗ |
| 300 | `Jump` | ✓ | ✓ | ✗ |
| 303 | `Move Cost Rain (P60):` | ✓ | ✓ | ✗ |
| 305 | `Move Cost Snow (P64):` | ✓ | ✓ | ✗ |
| 311 | `Terrain Avoid (P68):` | ✓ | ✓ | ✗ |
| 313 | `Terrain Def (P72):` | ✓ | ✓ | ✗ |
| 321 | `Terrain Res (P76):` | ✓ | ✓ | ✗ |
| 332 | `Growth Simulator` | ✓ | ✓ | ✗ |
| 336 | `Calculate Growth` | ✓ | ✓ | ✗ |
| 337 | `Sim Level:` | ✓ | ✓ | ✗ |
| 350 | `Warnings` | ✓ | ✓ | ✗ |
| 362 | `Write` | ✓ | ✓ | ✗ |
| 364 | `Export TSV` | ✓ | ✓ | ✗ |
| 365 | `Export all classes to a TSV file` | ✓ | ✓ | ✗ |
| 366 | `Import TSV` | ✓ | ✓ | ✗ |
| 367 | `Import classes from a TSV file` | ✓ | ✓ | ✗ |
| 369 | `Edit Skills` | ✓ | ✓ | ✗ |
| 371 | `Open skill assignment editor for this class` | ✓ | ✓ | ✗ |
