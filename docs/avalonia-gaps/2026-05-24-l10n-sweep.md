---
generated: "2026-05-22T22:38:59Z"
git-sha: 52c766ad7
sweep-type: l10n
languages: ja,zh,ko
---
...
| 76 | `The event runs when the player clears a map. It is responsible for spawning the next world map node and drawing the road to it.` | ✓ | ✓ | ✗ |
| 81 | `Global story events` | ✓ | ✓ | ✗ |
| 85 | `Opening Event` | ✓ | ✓ | ✗ |
| 94 | `Eirika Ending` | ✓ | ✓ | ✗ |
| 103 | `Ephraim Ending` | ✓ | ✓ | ✗ |
| 112 | `Write` | ✓ | ✓ | ✗ |
| 125 | `After (Stage Select)` | ✓ | ✓ | ✗ |
| 138 | `Top Address` | ✓ | ✓ | ✗ |
| 143 | `Read Count` | ✓ | ✓ | ✗ |
| 149 | `Reload` | ✓ | ✓ | ✗ |
| 156 | `Address` | ✓ | ✓ | ✗ |
| 161 | `Size:` | ✓ | ✓ | ✗ |
| 165 | `Selected Address:` | ✓ | ✓ | ✗ |
| 170 | `Write` | ✓ | ✓ | ✗ |
| 177 | `Event after stage selection` | ✓ | ✓ | ✗ |
| 179 | `Event Pointer (u32@0):` | ✓ | ✓ | ✗ |
| 187 | `The event runs when the player selects a node on the world map. FE8 lets the player move freely between nodes, so the introduction for the next chapter must happen as the node is selected.` | ✓ | ✓ | ✗ |
| 192 | `Related Editors` | ✓ | ✓ | ✗ |
| 195 | `Jump to World Map Points` | ✓ | ✓ | ✗ |
| 200 | `Jump to World Map Paths (roads)` | ✓ | ✓ | ✗ |
