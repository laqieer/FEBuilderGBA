---
generated: "2026-05-24T01:20:27Z"
git-sha: a7d2d4844
sweep-type: undo
---
...
| Tier | Count | % of total |
|---|---:|---:|
| Total write callsites | 1099 | 100% |
| NoUndoServiceField (no plumbing) | 149 | 13.6% |
| MissingScope (unwrapped) | 4 | 0.4% |
| AmbiguousScope (verify) | 0 | 0.0% |
| Covered (healthy) | 946 | 86.1% |
...
Classes with at least one detected write: 172.
